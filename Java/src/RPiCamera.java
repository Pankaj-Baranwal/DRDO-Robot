...
// 						"Desktop" + File.separator + "RPiCamera.out"));
	 ...
	 * @throws InterruptedException
	 */
	public InputStream takeBufferedStill(int width, int height) throws IOException, InterruptedException {
		List<String> command = new ArrayList<>();
		command.add("raspistill");
		command.add("-o");
		command.add("-v");
	 ...
	 * @throws InterruptedException
	 */
	public InputStream takeBufferedStill() throws IOException, InterruptedException {
